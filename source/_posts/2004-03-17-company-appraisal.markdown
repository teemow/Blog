...
* Determine the time horizon for your forecast
* Look at economic and business cycle
* Consider positive and negative growth
* Conside the time of above-average returns
...
* Estimate the WACC including the determination of debt/equity ratio.
* Discount the cash flows
* Determine enterprise value
* Determine equity value
* Conduct sensitivity analysis
* Potentially prepare related financial statements.
